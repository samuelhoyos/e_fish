...
if __name__ == "__main__":
    ...
    for_compiler.write_input(
        first_osc=first_osc,
        last_osc=last_osc,
        delta_t=fwhm,
        t_diff=t_diff,
        pos_path=data_path,
        input_path=f"{date}/input_{pos_volt}.dat",
        bcs1_gen_name=f"C11--{joined_date}_Air150mbar_{voltage}kV--",
        bcs2_gen_name=f"C44--{joined_date}_Air150mbar_{voltage}kV--",

...
!---------------------------------INPUT---------------------------------
    ...
    real*16 trigger                          
    character(len=256) :: part1, part2, part3, part4, parte                             ![a.u.], trigger level of BCS1 and BCS2 signals
...
!-----------------------------INITIALIZATION----------------------------
    ...
    part1 = "C:/Users/samue/OneDrive/Documentos/2024/LPP/M1_internship/"
    part2= "data/2024_05_16/"
    part3= "input_pos2_27.dat"
    !part2 = trim("data/2024_05_16/input_pos2_27.dat")
    inputfile = trim(part1)// trim(part2)// trim(part3)

    !part3 ="C:/Users/samue/OneDrive/Documentos/2024/LPP/M1_internship/"
    part4 = "output_pos2_27_bkgd.dat"
    outputfile = trim(part1)// trim(part2)// trim(part4)
    !print *, "Input file: ", inputfile
    !print *, "Output file: ", outputfile
   
    emissionfile='C3--20240516_Air150mbar_27kV_BG1_inverted.txt'
!------------------------------DEALLOCATION-----------------------------
...
!------------TIMING DEFINITION FOR AVERAGED EMISSION SIGNAL-------------
    ...
    parte="pos2_27kV/pos2_27kV/"
    
   
    emissionpath=trim(part1)// trim(part2)// trim(parte)
    !emissionpath="C:\Users\samue\OneDrive\Documentos\2024\LPP\M1_internship\data\2024_05_16\pos2_27kV\pos2_27kV"
